...
<details>
<summary>About PRGPT</summary>

### PRGPT

This review was generated by **PRGPT**, an AI-powered code reviewer.
</details>
`
...
### Chat with PRGPT Bot (\`@prgpt\`)
- Reply on review comments left by this bot to ask follow-up questions. A review comment is a comment on a diff or a file.
- Invite the bot into a review comment chain by tagging \`@prgpt\` in a reply.
...
- Add \`@prgpt: ignore\` anywhere in the PR description to pause further reviews from the bot.
