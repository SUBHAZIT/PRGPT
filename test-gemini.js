...
import { Options, GeminiOptions } from './options.ts';
import { TokenLimits } from './limits.ts';
dotenv.config();
async function testGemini() {
    const options = new Options(true, // debug
    false, // disableReview
    ...
    'gemini-2.0-flash', 'gemini-2.5-pro', '0.7', '3', '120000', '6', '6', 'en-US');
    ...
    try {
        ...
        const [response, ids] = await bot.chat('Hello! Can you summarize that you are PRGPT powered by Gemini?', {});
