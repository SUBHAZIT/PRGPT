...
module.exports = eval("require")("./bot");
...
module.exports = eval("require")("./review");
...
module.exports = eval("require")("./review-comment");
...
/* harmony import */ var _bot__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(187);
/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(945);
/* harmony import */ var _prompts__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(640);
/* harmony import */ var _review__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(504);
/* harmony import */ var _review_comment__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(916);
...
async function run() {
    ...
    // print options
    options.print();
    const prompts = new _prompts__WEBPACK_IMPORTED_MODULE_3__.Prompts((0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('summarize'), (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('summarize_release_notes'));
    // Create two bots, one for summary and one for review
    let lightBot = null;
    try {
        lightBot = new _bot__WEBPACK_IMPORTED_MODULE_1__.Bot(options, new _options__WEBPACK_IMPORTED_MODULE_2__.GeminiOptions(options.geminiLightModel, options.lightTokenLimits));
    }
    catch (e) {
    ...
    let heavyBot = null;
    try {
        heavyBot = new _bot__WEBPACK_IMPORTED_MODULE_1__.Bot(options, new _options__WEBPACK_IMPORTED_MODULE_2__.GeminiOptions(options.geminiHeavyModel, options.heavyTokenLimits));
    }
    catch (e) {
    ...
    try {
        ...
        if (process.env.GITHUB_EVENT_NAME === 'pull_request' ||
            ...
            await (0,_review__WEBPACK_IMPORTED_MODULE_4__.codeReview)(lightBot, heavyBot, options, prompts);
        }
        else if (process.env.GITHUB_EVENT_NAME === 'pull_request_review_comment') {
            await (0,_review_comment__WEBPACK_IMPORTED_MODULE_5__.handleReviewComment)(heavyBot, options, prompts);
        }
        else {
